...
const raw: RawCake[] = [
  { name: "Classic Vanilla Birthday Cake", description: "Soft vanilla sponge layered with buttercream, finished with festive sprinkles.", price: 18000, sizeLabel: "8-inch, serves 12", flavour: "Vanilla", occasion: "birthday", quantityAvailable: 6, sameDayPickup: true, image: "/images/cakes/vanilla-birthday.jpg" },
  { name: "Red Velvet Celebration Cake", description: "Rich red velvet layers with cream cheese frosting.", price: 22000, sizeLabel: "8-inch, serves 12", flavour: "Red Velvet", occasion: "birthday", quantityAvailable: 4, sameDayPickup: true, image: "/images/cakes/red-velvet.jpg" },
  ...
  { name: "Chocolate Fudge Anniversary Cake", description: "Decadent chocolate fudge cake with chocolate ganache drip.", price: 25000, sizeLabel: "8-inch, serves 14", flavour: "Chocolate Fudge", occasion: "anniversary", quantityAvailable: 5, sameDayPickup: true, image: "/images/cakes/chocolate-anniversary.jpg" },
  ...
  { name: "Corporate Logo Cake", description: "Custom-branded cake featuring your company logo in edible print.", price: 40000, sizeLabel: "10-inch, serves 25", flavour: "Chocolate", occasion: "corporate", quantityAvailable: 3, sameDayPickup: false, image: "/images/cakes/corporate-logo.jpg" },
  ...
  { name: "Assorted Cupcake Box (12 pcs)", description: "A dozen mixed-flavour cupcakes, perfect for small celebrations.", price: 9000, sizeLabel: "Box of 12", flavour: "Assorted", occasion: "birthday", quantityAvailable: 10, sameDayPickup: true, image: "/images/cakes/cupcake-box.jpg" },
];
